      ...
      <div className="inputContainer">
        ...
        <div>
          ...
          <div className="text">
            ...
            Isolating the outer walls with 300 mm of insulation. This
            improvement will cost 485.000 kr. and you will be eligible for a
            40.000 kr subsidy from the government. Below you can see your
            estimated savings for your appartment over the coming years. Your
            energy improvement investment will break even within seven years.
          </div>
          <div className="plot">
            <LineChart
              width={1052}
